                        ...
                        <CommandGroup heading="Workspace Members">
                            <ScrollArea className="max-h-32">
                                {liveUsers.map(user => (
                                    ...
                                    >
                                        <Checkbox
                                            id={`user-add-task-${user.id}`}
                                            checked={selectedUsers.includes(user.id)}
                                            onCheckedChange={() => handleUserSelect(user.id)}
                                            className="mr-2"
                                        />
                                        <label htmlFor={`user-add-task-${user.id}`} className="flex-1 cursor-pointer">{user.name}</label>
                                    </CommandItem>
                                ))}
                            </ScrollArea>
                        </CommandGroup>
                                ...
                                {importedUsers.map(user => (
                                    ...
                                    >
                                        <Checkbox
                                            ...
                                            className="mr-2"
                                        />
                                        <label htmlFor={`user-add-task-imported-${user.id}`} className="flex-1 cursor-pointer text-blue-400">{user.name}</label>
                                    </CommandItem>
                                ))}
                                </ScrollArea>
                            </CommandGroup>
